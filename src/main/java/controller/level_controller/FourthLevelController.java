...
public class FourthLevelController extends AbstractController implements Initializable {
    ...
    @Override
    public void show() {
        loadControllerWindow(this, "fxml/level/fourthLevel.fxml");
    }
}
